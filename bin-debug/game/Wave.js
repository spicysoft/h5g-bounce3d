        ...
        if (this.milestone <= Player.I.z) {
            ...
            if (randBool(Util.lerp(1.0, 0.4, Game.hard))) {
                ...
                if (randBool(0.9)) {
                    ...
                    var maxLane = Math.floor(LANES / 2);
                    var minLane = -maxLane;
                    var type = randI(0, ObsType.Total);
                    if (type == ObsType.SlideL)
                        maxLane--;
                    if (type == ObsType.SlideR)
                        minLane++;
                    var lane = randI(minLane, maxLane + 1);
                    ...
                    var xc = Util.w(0.5);
                    var xw = Util.w(LANE_WIDTH_PER_W);
                    var y = Util.h(0.5) + Util.w(0.3);
                    var z = Player.I.z + Util.w(4);
                    switch (randI(0, 11 + 1)) {
                        case 0:
                            new Obstacle(ObsType.Fixed, xc + lane * xw, y, z);
                            lane++;
                            lane++;
                            lane++;
                            new Obstacle(ObsType.Fixed, xc + lane * xw, y, z);
                        ...
                        case 5:
                            lane++;
                            lane++;
                            new Obstacle(ObsType.SlideR, xc + lane * xw, y, z);
                            lane++;
                            new Obstacle(ObsType.SlideR, xc + lane * xw, y, z);
                            lane++;
                            lane++;
                        ...
                        case 6:
                            lane++;
                            new Obstacle(ObsType.SlideL, xc + lane * xw, y, z);
                            lane++;
                            new Obstacle(ObsType.SlideL, xc + lane * xw, y, z);
                            lane++;
                            lane++;
                            ...
                            break;
                        case 7:
                            new Obstacle(ObsType.JumpUp, xc + lane * xw, y, z);
                            lane++;
                            new Obstacle(ObsType.JumpUp, xc + lane * xw, y, z);
                            lane++;
                            new Obstacle(ObsType.JumpOn, xc + lane * xw, y, z);
                            lane++;
                            lane++;
                            lane++;
                            break;
